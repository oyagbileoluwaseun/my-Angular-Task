...
export class AddComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.productForm.addControl('nameFirstName',new FormControl('',[Validators.required]));
    this.productForm.addControl('nameLastName',new FormControl('',[Validators.required]));
    this.productForm.addControl('address',new FormControl('',[Validators.required]));
    this.productForm.addControl('phoneNumber',new FormControl('',[Validators.required]));
      ...
      switchMap((params: ParamMap) =>
        ...
        product$.subscribe(product=>{
          if(!isNullOrUndefined(product)){
            ...
            this.productForm.get('nameFirstName').setValue(product.nameFirstName);
            this.productForm.get('nameLastName').setValue(product.nameLastName);
            this.productForm.get('address').setValue(product.address);
            this.productForm.get('phoneNumber').setValue(product.phoneNumber);
  ...
  saveProduct():void{
    ...
    product.nameFirstName = this.productForm.get('nameFirstName').value;
    product.nameLastName = this.productForm.get('nameLastName').value;
    product.address = this.productForm.get('address').value;
    product.phoneNumber = this.productForm.get('phoneNumber').value;
